...
header .opt a {text-decoration: none;font-family:cursive;text-align: center;font-size:20px;color:blue;margin-right: 15px}
header .opt a:hover {opacity: 0.8;cursor: pointer;}
header .opt #inp {padding:3px;margin:0px 0px 0px 33px;background-color:#00A8A9;font-family:cursive;font-size:16px; opacity: 0.6;color:black;}
...
header .opt p {font-family:cursive;text-align: left;font-size:19px;color:#Black;}
...
<header >
	...
	<div class="head">
		...
		<h1>RFID<br>Digital Attendance</h1>
	</div>	        
